...
public class SimpleView extends javax.swing.JFrame implements Observer{
    ...
    Boolean printActividades = Boolean.FALSE;
    /**
    ...
    private void RecuperarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RecuperarActionPerformed
        ...
        if (returnValue == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                printActividades = Boolean.TRUE; //check later
            } catch (Exception e) {
                System.out.print("Error cargando el archivo XML");
            }
        }
    ...
    public void clear(){
        printActividades = Boolean.FALSE;
        this.repaint();
    }
